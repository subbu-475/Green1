...
export function ServicesContent() {
 ...
 <p className="mt-5 max-w-4xl text-black md:">
 ...
 <p className="mb-4 text-black">In-house training allows you to:</p>
...
"In-house training fosters a 'team' approach to WGBO providing an opportunity for team building through learning.",
 ...
 <p className="text-black">Just mail us to <a href="mailto:enquiry@wgbo.org.in" className="font-medium text-emerald-600 hover:underline">enquiry@wgbo.org.in</a> to get the cost.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 *You will need to complete the post-course online quiz to release the World Green Building CPD points. On-demand courses that do not earn CPD points are specified.
 ...
 <p className="text-black">To view our full on-demand course list follow the link here. You will need to sign into your WGBO account to purchase a course.</p>
 </div>
 </div>
 </div>
 </div>
