...
export function CertificationContent() {
    return (
        <div className="pt-8">
            ...
            <section id="professional" className="scroll-mt-32 bg-gray-50/70 px-6 py-8 md:py-10">
                <div className="mx-auto max-w-7xl">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="h-8 w-1 rounded-full bg-emerald-500" />
                        <span className="text-xs font-semibold uppercase tracking-[0.25em] text-emerald-600 font-heading">
            ...
            {/* ═══ World Green Building Accredited Professional (WGBAP) ═══ */}
            <section id="wgbap" className="scroll-mt-32 bg-gray-50/70 px-6 py-8 md:py-10">
                <div className="mx-auto max-w-7xl">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="h-8 w-1 rounded-full bg-emerald-500" />
                        <span className="text-xs font-semibold uppercase tracking-[0.25em] text-emerald-600 font-heading">
                    ...
                    <div className="mt-6 text-[16px] leading-[1.8] text-black-800 space-y-4 max-w-6xl">
                        ...
                        <ul className="list-disc pl-6 space-y-2 mb-6">
                            <li>Has more than 3 years of relevant work experience and local industry practice</li>
                            <li>Possesses technical proficiency in the World Green Building scheme</li>
                            <li>Takes the lead in the integration of multi-disciplinary requirements to meet World Green Building certification standards</li>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 my-8">
                            <div>
                                ...
                                <p className="mb-3">World Green Building Accredited Professional (WGBAP) is suitable for:</p>
                                <ul className="space-y-2">
                                    {[
                                        "Built Environment Professionals",
                                        "Sustainability Exclusive",
                                        "Sustainability-related Professionals",
                                        "Green Building certified World Green Building Associate (WGBA)"
                                    ].map((item, i) => (
                                        <li key={i} className="flex items-start gap-2">
                                            <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0 mt-0.5" />
                                            <span>{item}</span>
                            ...
                            <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <strong className="block text-gray-800">Course Requirement</strong>
                                        <span>Attend and pass the Certification Course for World Green Building Associate (WGBA).</span>
                                    </div>
                                    <div>
                                        <strong className="block text-gray-800">Renewal of Certification</strong>
                                        <span>All qualifications under the World Green Building Accredited Professional (WGBAP) Professional Qualification Scheme require annual renewal.</span>
                                    </div>
                                    <p className="text-sm mt-2">
                                        For Any further question, you can contact our <a href="mailto:enquiry@wgbo.org.in" className="text-emerald-600 font-medium hover:underline">enquiry@wgbo.org.in</a>
                                    </p>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-gray-900 font-heading mb-4">Processing of Application</h3>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>There is a one-time non-refundable payment of $100+ (subject to GST charges) upon application submission, regardless of application outcome.</li>
                                <li>Applications found ineligible or invalid will be returned to the applicant for resubmission of documents.</li>
                                <li>Applications left incomplete will expire after 3 months.</li>
                                <li>Please allow approximately 2 months for our officers to process your application upon submission.</li>
                                <li>Applicants will be notified via email of their application status.</li>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    "Learning & Development activities organised by partner World Green Building Organization (GBCs), such as the World Safety Organization India (WGBO I)."
                                ].map((item, i) => (
